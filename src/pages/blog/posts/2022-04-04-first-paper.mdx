...
To model AI memory, I explored various ways to store information and ultimately opted for [**knowledge graphs**](https://arxiv.org/abs/2003.02320), which are both human- and machine-readable. The next step was to determine whether an explicit memory system would be beneficial for an AI agent.
